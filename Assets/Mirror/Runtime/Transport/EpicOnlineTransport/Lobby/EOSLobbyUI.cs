...
public class EOSLobbyUI : EOSLobby
{
    ...
    private void DrawMenuButtons()
    {
        ...
        //create lobby button
        if (GUILayout.Button("Create Lobby", GUILayout.MinHeight(buttonHeight)))
        {
        ...
        //find lobby button
        if (GUILayout.Button("Find Lobbies", GUILayout.MinHeight(buttonHeight)))
        {
            FindLobbies();
        }
        ...
        if (GUILayout.Button("Leave Lobby", GUILayout.MinHeight(buttonHeight)))
        {
            LeaveLobby();
        }
